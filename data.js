...
const COMPANY_INFO = {
    name: "四川巨鲸兽药销售有限公司",
    nameEn: "GIANT WHALE",
    slogan: "专业动物保健品<br><span>销售服务商</span>",
    // Hero区域显示的简短标语
    heroBadge: "GSP 认证企业",
    heroSubtext: "标准化生产 · 品质保障",
    // 公司简介（完整版，用于公司介绍区域）
    description: "四川巨鲸兽药销售有限公司是福建巨鲸生物科技集团、四川德成动物保健品有限公司合资成立、由巨鲸集团控股的动物保健品销售公司，公司位于四川德阳市中江县经济开发区。公司拥有遍及全国二十多个省市的销售网络，依托四川德成现有技术研发、生产设施，优势互补，强强联合。目前公司与四川德成联合生产，新建生产车间和库房8000余平方米，拥有通过农业部新版GMP认证的17种剂型和8个车间及18条生产线，是GSP认证企业，形成规模大、剂型全、设备先进的动物保健品研发、生产、销售基地。",
    // 背景图片URL（可自定义）
    backgroundImage: "",
    established: "2015",
    ...
    highlights: ["GSP认证", "17种剂型", "18条生产线", "8000㎡厂房", "全国销售网络"],
    features: [
